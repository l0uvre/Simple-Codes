--
-- This is a procedure that cleans up first names starting with a space
-- Written for SQLite.
--
...
-- Populate it (we could have done a CREATE TABLE ... AS SELECT ..)
...
; 
-- 
-- Merging of people entered twice by mistake
--      
...
-- people to merge
;
-- '' and NULL is the same only with Oracle
